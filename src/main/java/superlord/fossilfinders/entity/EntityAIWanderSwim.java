...
public abstract class EntityAIWanderSwim extends EntityTameable {
    ...
    public EntityAIWanderSwim(World world) {

        super(world);

        this.spawnableBlock = Blocks.WATER;

        this.moveHelper = new EntityAIWanderSwim.SwimmingMoveHelper();
    ...
    public EntityAIWanderSwim getClosestMate() {

        EntityAINearestAttackableTarget.Sorter theNearestAttackableTargetSorter = new EntityAINearestAttackableTarget.Sorter(this);

        List<EntityAIWanderSwim> list = world.getEntitiesWithinAABB(EntityAIWanderSwim.class, this.getEntityBoundingBox().expand(2.0D, 2.0D, 2.0D), null);
    ...
    class SwimmingMoveHelper extends EntityMoveHelper {
        ...
        private final EntityAIWanderSwim dinosaur = EntityAIWanderSwim.this;



        public SwimmingMoveHelper() {

            super(EntityAIWanderSwim.this);
